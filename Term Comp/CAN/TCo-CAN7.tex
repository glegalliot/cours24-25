...
\maketitle
    ...
    Pour les questions \textbf{1.}, \textbf{2.} et \textbf{3.}, on donne les courbes de deux fonctions $f$ et $g$ :\\\begin{tikzpicture}[baseline,scale = 0.6]
    ...
    \begin{enumerate}[itemsep=0.3cm]
        ...
        \item Équation réduite de la droite $(AB)$.\\\begin{tikzpicture}[baseline,scale = 0.6]
