...
\exo{}
\textcolor{UGLiBlue}{\dleft{14.5cm}{
...
\begin{enumerate}
    ...
    \item \begin{enumalph}
        \item $P(X=3)=\left(\dfrac{5}{6}\right)^2\times\dfrac{1}{6}=\dfrac{25}{216}$.
        \item $P(X>5)=\left(\dfrac{5}{6}\right)^5=\dfrac{3125}{7776}$.
        \item $P(X\leqslant5)=1-P(X>5)=1-\dfrac{3125}{7776}=\dfrac{4651}{7776}$.
    \end{enumalph}
\end{enumerate}
