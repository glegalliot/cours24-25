...
\classe{\premiere spé}
\titre{Evaluation-bilan 2 - Sujet B}
\maketitle
\begin{center}
...
\dleft{10cm}{
    \includegraphics[width=10.5cm]{courbesB.jpg}
}
{
    \begin{enumalph}
...
\exo{}\bareme{10 pts}
\begin{enumerate}
    \item On définit la fonction $f$ sur $\R$ par : $\quad f(x)=-2x^2-3x+2$.
    \begin{enumalph}
    ...
    \item On définit la fonction $g$ sur $\R$ par : $\quad g(x)=3x^2-x+1$.
    \begin{enumalph}
...
\dleft{11.5cm}{
    ...
    ABCD est un carré de côté 5 cm. AFKE et KHCG sont des carrés.\\
